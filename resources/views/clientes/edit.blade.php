...
<h1 class="mb-4 text-2xl font-bold">Editar cliente</h1>

<form action="{{ route('clientes.update', $cliente) }}" method="POST" class="max-w-lg">
    @csrf
    @method('PUT')
    ...
    <div class="mb-4">
        ...
        <input type="text" name="rut_empresa" id="rut_empresa"
               value="{{ old('rut_empresa', $cliente->rut_empresa) }}" class="w-full rounded border p-2">
        @error('rut_empresa')
    ...
    <div class="mb-4">
        ...
        <input type="text" name="razon_social" id="razon_social"
               value="{{ old('razon_social', $cliente->razon_social) }}" class="w-full rounded border p-2">
        @error('razon_social')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="text" name="rubro" id="rubro"
               value="{{ old('rubro', $cliente->rubro) }}" class="w-full rounded border p-2">
        @error('rubro')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="text" name="telefono" id="telefono" maxlength="20"
               value="{{ old('telefono', $cliente->telefono) }}" class="w-full rounded border p-2">
        @error('telefono')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="text" name="direccion" id="direccion"
               value="{{ old('direccion', $cliente->direccion) }}" class="w-full rounded border p-2">
        @error('direccion')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="text" name="nombre_contacto" id="nombre_contacto"
               value="{{ old('nombre_contacto', $cliente->nombre_contacto) }}" class="w-full rounded border p-2">
    ...
    <div class="mb-4">
        ...
        <input type="email" name="email_contacto" id="email_contacto"
               value="{{ old('email_contacto', $cliente->email_contacto) }}" class="w-full rounded border p-2">
